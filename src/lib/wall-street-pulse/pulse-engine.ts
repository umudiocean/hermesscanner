...
export function calculatePulse(inputs: PulseInputs): PulseData {
  ...
  const components: PulseComponent[] = [
    ...
    { id: 'vix', name: 'Volatilite (VIX)', value: vixScore, weight: WEIGHTS.vix, available: true, source: inputs.vixValue != null ? 'FRED/Finnhub' : 'Beta proxy', description: 'Piyasa korku endeksi', direction: 'flat', rawValue: inputs.vixValue ?? undefined },
