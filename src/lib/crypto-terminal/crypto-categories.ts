...
const CATEGORY_STYLE: Record<CryptoCategory, { bg: string; text: string }> = {
  L1: { bg: 'bg-blue-500/15', text: 'text-blue-300' },
  ...
  Stablecoin: { bg: 'bg-emerald-500/15', text: 'text-emerald-300' },
  DEX: { bg: 'bg-violet-500/15', text: 'text-violet-300' },
  Oracle: { bg: 'bg-orange-500/15', text: 'text-orange-300' },
  Privacy: { bg: 'bg-gray-500/15', text: 'text-gray-300' },
  RWA: { bg: 'bg-amber-500/15', text: 'text-amber-300' },
  NFT: { bg: 'bg-rose-500/15', text: 'text-rose-300' },
  Infra: { bg: 'bg-teal-500/15', text: 'text-teal-300' },
  CEX: { bg: 'bg-red-500/15', text: 'text-red-300' },
