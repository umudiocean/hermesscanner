        ...
        <div className="absolute right-0 top-full mt-2 z-50 animate-fade-in">
          <div className="bg-[#131318] border border-stroke rounded-2xl shadow-2xl shadow-black/40 p-3 w-[280px] max-w-[calc(100vw-2rem)]"
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-2 py-2 rounded-xl bg-gradient-to-r from-amber-500/10 to-orange-500/8 border border-amber-500/20 text-gold-400 text-[11px] font-bold hover:from-amber-500/20 hover:to-orange-500/15 hover:border-stroke-gold-strong transition-all duration-200 hover:scale-[1.02]"
            >
              {copied ? (
                <>
