        ...
        <form onSubmit={handleLogin} className="bg-[#151520] rounded-2xl border border-white/8 p-6 shadow-xl space-y-4">
          <div>
            ...
            <input
              ...
              className="w-full bg-[#0c0c14] border border-white/10 rounded-xl px-4 py-3 text-white/90 placeholder:text-white/20 focus:outline-none focus:border-[#B3945B]/50 transition-colors"
              autoFocus
